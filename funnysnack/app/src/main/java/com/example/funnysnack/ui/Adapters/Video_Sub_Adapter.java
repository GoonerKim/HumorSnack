...
import com.example.funnysnack.ui.Activities.Video_Play_Activity;
import com.example.funnysnack.ui.Datas.Video;
import com.example.funnysnack.R;

import java.util.ArrayList;

public class Video_Sub_Adapter extends RecyclerView.Adapter<Video_Sub_Adapter.ViewHolder> {

    private ArrayList<Video> items = new ArrayList<>();

    @NonNull
    @Override
    public Video_Sub_Adapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {

        View itemView;
        Video_Sub_Adapter.ViewHolder viewHolder;

        itemView = LayoutInflater.from(parent.getContext()).inflate(R.layout.video_item_sub, parent, false);
    ...
    @Override
    public void onBindViewHolder(@NonNull Video_Sub_Adapter.ViewHolder viewHolder, int position) {
        ...
        viewHolder.view.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                intent.putExtra("video_title", item.getThumbnail());
